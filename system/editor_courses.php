...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body>
    ...
    <iframe src="banner.php?cate=5" onload="SetCwinHeight(this);"></iframe>
    <iframe id="console_post_iframe" src="console_post.php?part=course" onload="SetCwinHeight(this);"></iframe>
  </body>
</html>
